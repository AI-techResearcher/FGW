...
import { dummyBookmark, dummyChatHistory, optionsMonth, optionsWeek } from '@/lib/data/dummyData'
// const responsive = {
//   desktop: {
...
export default function Dashboard() {
  ...
  return (
    <div className='py-3 max-w-screen-2xl w-full space-y-5 px-3' id='dashboard'>
      <section className=' flex flex-wrap sm:grid grid-cols-1 md:grid-cols-12 gap-2'>
        ...
        <div className='bg-white col-span-7 blue py-3 card'>
          <p className='font-semibold ps-5 text-sm mb-0 sm:mb-3'>Monthly time spent</p>
          <Chart
      ...
      <section className='flex flex-wrap sm:grid grid-cols-2 gap-2'>
        <div className='bg-white blue py-3 card'>
          <p className='font-semibold ps-5 text-sm mb-0 sm:mb-3'>Weekly Time Spent</p>
          <Chart
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <div className='capitalize'>
                            <TableCell className='font-medium sm:text-base text-[12px] cursor-pointer'>
                              {e.name}
                            </TableCell>
                          </div>
                        </DialogTrigger>
      ...
      <section className='flex flex-wrap sm:grid grid-cols-12 gap-3'>
          ...
          <Table>
            ...
            <TableBody>
              {dummyChatHistory.map((e, i) => {
                ...
                return (
                  <TableRow key={i} className='dark:b order-gray-600'>
                    <TableCell className='font-medium sm:text-base text-[12px]'>{e.name}</TableCell>
                    <TableCell className='sm:text-base text-[12px]'>{e.date}</TableCell>
