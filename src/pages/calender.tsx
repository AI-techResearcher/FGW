...
import { optionsMonth, optionsWeek } from '@/lib/data/dummyData'
...
export default function CalenderPage() {
  ...
  return (
    <div className='py-3 max-w-screen-2xl  w-full  space-y-5 px-3' id='dashboard'>
      <section className='flex flex-wrap sm:grid gap-2 w-full grid-cols-12'>
        <div className='card col-span-6 w-full '>
      ...
      <section className='flex flex-wrap  sm:grid gap-2 grid-cols-12'>
